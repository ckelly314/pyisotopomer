...
Where $(^{15}R^{\alpha} )(^{15}R^{\beta} )_0$ represents the background $^{15}N^{15}N^{16}O$, calculated from $^{15}R^{\alpha}$ and $^{15}R^{\beta}$ at t0. $^{15}N^{15}N^{16}O_{excess}$ represents the amount of $^{15}N^{15}N^{16}O$ added to the sample over the course of the experiment.
