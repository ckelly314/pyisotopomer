...
def parseoutput(inputobj, initialguess=None, lowerbounds=None, upperbounds=None):
    ...
    maindf = pd.DataFrame([], columns=['ref_tag_1', 'size corrected 31R_1', 'size corrected 45R_1',
       'size corrected 46R_1', 'ref_tag_2', 'size corrected 31R_2',
       'size corrected 45R_2', 'size corrected 46R_2', 'gamma', 'kappa'])
