...
def concentration44(peakarea44, sampleweight, conversionslope, conversionint=None):
    ...
    liter_g = liter_kg/1000. # seawater L/g = L/kg/1000
...
def concentrations(peakarea44, sampleweight, conversionslope, isotoperatios, conversionint=None):
...
if __name__=='__main__':
    print(concentrations(peakarea44=10, sampleweight=153, conversionslope=0.48, isotoperatios=pd.DataFrame([[1,2,3,4]])))
